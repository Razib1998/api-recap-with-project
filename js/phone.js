...
const showPhoneDetail = (phone) => {
  ...
  phoneDetailContainer.innerHTML = `
    ...
    <p class = "font-bold"><span class = "font-normal">brand: </span>${
      phone?.brand
    }</p>
    <p class = "font-bold"><span class = "font-normal">Chip: </span>${
      phone?.mainFeatures?.chipSet
    }</p>
    <p class = "font-bold"><span class = "font-normal">Display-Size: </span>${
      phone?.mainFeatures?.displaySize
    }</p>
    <p class = "font-bold"><span class = "font-normal">Memory: </span>${
      phone?.mainFeatures.memory
    }</p>
    <p class = "font-bold"><span class = "font-normal">Storage: </span>${
      phone?.mainFeatures?.storage
    }</p>
    <p class = "font-bold"><span class = "font-normal">Release-Date: </span>${
      phone?.releaseDate
    }</p>
    <p class = "font-bold"><span class = "font-normal">Name: </span>${
      phone?.slug
    }</p>
    <p class = "font-bold"><span class = "font-normal">GPS: </span>${
      phone?.others?.GPS || "NO GPS available in this device"
    }</p>
